...
var Controller = /** @class */ (function () {
    ...
    Controller.prototype.index = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var zoom_body, _a, success, error, err_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, service_1.default.readZoomBody(zoom_body)];
                    case 1:
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, res.status(500).json({ message: 'Operation was not successful.' })];
